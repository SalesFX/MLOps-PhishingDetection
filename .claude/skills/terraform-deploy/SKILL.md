...
O projeto fica em `/home/samuelsales/DevOps-projetos/Network-Security-System-MLOps-Project/`. As stacks Terraform ficam em `infra/` na raiz do projeto. São diretórios dentro de `infra/` que:
- Contêm arquivos `*.tf`
...
```bash
ls -d /home/samuelsales/DevOps-projetos/Network-Security-System-MLOps-Project/infra/*/
```

## Argumentos

- **Com argumento** (ex: `terraform-deploy 01-s3-ecr`): faz o deploy apenas da stack especificada
...
✓ apply    — Apply complete! Resources: 5 added
```
