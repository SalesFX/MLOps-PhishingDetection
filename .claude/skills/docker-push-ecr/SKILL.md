...
```
/docker-push-ecr . <account_id>.dkr.ecr.us-east-1.amazonaws.com/network-security:latest
```

```
/docker-push-ecr . <account_id>.dkr.ecr.us-east-1.amazonaws.com/network-security:v1.0.0
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Imagem 1: devops-ia/production/backend:v1.0.0
  App:    devops-ia-apps/backend/YoutubeLiveApp
  ✓ Build OK (linux/amd64)
  ✓ Push OK
  ✓ Verificado no ECR
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Imagem 2: devops-ia/production/frontend:v1.0.0
  App:    devops-ia-apps/frontend/youtube-live-app
  ✓ Build OK (linux/amd64)
  ✓ Push OK
  ✓ Verificado no ECR
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- O projeto base fica em `/home/samuelsales/DevOps-projetos/Network-Security-System-MLOps-Project/` — caminhos relativos sao resolvidos a partir dai. O Dockerfile principal fica na raiz do projeto (`.`)
